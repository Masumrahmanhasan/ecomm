    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-3 sidebar">
                            ...
                            for ($i = 0; $i < count($category); $i++) {
                                ...
                                <li class="dropdown menu-item">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                                            ...
                                            aria-hidden="true"></i><?= $category[$i]['name'] ?></a>
                                                    ...
                                                    <div class="categories ">
                                                        <div class="row">
                                                            <?php foreach ($sub_category as $sub_category) {
                                                                ...
                                                                <div class="col-lg-4 imran">
                                                                    <div class="menu">
                                                                        <ul>
                                                                            <li class="subName">
                                                                                <a style="font-weight: bold;"
                                                                                   href="http://localhost/snapkart/index.php/home/category/1/13"
                                                                                   class="main-menu">
                                                                                    <?= $sub_category['name'] ?> </a>
                                                                                <ul>
                ...
                <!-- /.side-menu -->
                <!-- ================================== TOP NAVIGATION : END ================================== -->
                <div class="app-img outer-bottom-xs"><img alt="app"
                                                          src="<?= base_url(); ?>frontend_assets/app-img.jpg"/></div>
            </div>
                                        ...
                                        <div class="item item-carousel">
                                            <div class="products">
                                                <div class="product">
                                                    <div class="product-image">
                                                        <div class="image"><a
                                                                href="<?= base_url() ?>Home/get_product_detail/<?php echo $product_detail['product_id']; ?>"><img
                                                                    src="<?= $product_detail['image_name']; ?>" alt=""></a>
                                                        </div>
                                                        <!-- /.image -->
                                                    ...
                                                    <div class="product-info text-left">
                                                        <h3 class="name"><a
                                                                href="<?= base_url() ?>Home/get_product_detail/<?php echo $product_detail['product_id']; ?>"><?php echo $product_detail['product_name']; ?></a>
                                                        </h3>
                                                        <div class="rating rateit-small"></div>
                                                        <div class="description"></div>
                                                        <div class="product-price"><span
                                                                class="price">Rs. <?= $product_detail['sale_price']; ?> </span>
                                                            <!--<span class="price-before-discount"></span>--> </div>
                                                        <!-- /.product-price -->
                        ...
                        <?php foreach ($featured as $feature) { ?>
                            <div class="item item-carousel">
                                <div class="products">
                                    <div class="product">
                                        <div class="product-image">
                                            <div class="image"><a href="<?=base_url();?>Home/get_product_detail/<?=$feature['product_id']?>"><img
                                                        src="<?=$feature['image_name'];?>" alt=""></a></div>
                                            <!-- /.image -->
                                        ...
                                        <div class="product-info text-left">
                                            <h3 class="name"><a href="<?=base_url();?>Home/get_product_detail/<?=$feature['product_id']?>"><?=$feature['product_name'];?></a>
                                            </h3>
                                            <div class="rating rateit-small"></div>
                                            <div class="description"></div>
                                            <div class="product-price"><span class="price"> <?=$feature['sale_price'];?> </span>
