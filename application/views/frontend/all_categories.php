                                ...
                                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <div class="product-wrapper mb-40">
                                        <div class="product-img">
                                            <a href="#">
                                                <img src="<?=base_url()?>frontend_assets/img/product/1.jpg" alt="product" class="primary"/>
                                                <img src="<?=base_url()?>frontend_assets/img/product/2.jpg" alt="product" class="secondary"/>
                                            </a>
                                        ...
                                        <div class="product-content pt-20">
                                            ...
                                            <h2><a href="product-details.html"><?=$products[$i]['product_name'];?></a></h2>
                                            <div class="price">
                                                <ul>
                        ...
                        <div class="Categories-list">
                            <ul>
                                ...
                                foreach ($categories as $category) :
                                    ...
                                    ?>
                                <li><a href="#" onclick="getProducts(<?=$category['id']?>)"><?=$category['name']?> (<?=$items['items'];?>)</a></li>
