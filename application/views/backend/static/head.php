...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>backend_assets/<?php echo $theme?>/css/vendor.min.css">
    <link rel="stylesheet" href="<?= base_url() ?>backend_assets/<?php echo $theme?>/css/main.css">
    <link rel="stylesheet" href="<?= base_url() ?>backend_assets/<?php echo $theme?>/css/application.min.css">
