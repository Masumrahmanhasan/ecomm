<div class="layout-footer">
    <div class="layout-footer-body">
        ...
        <small class="copyright">2017 &copy; Technologicx <a href="https://technologicx.com/">Made by Technologicx</a>
        </small>
    </div>
</div>
</div>
                ...
                <div class="custom-scrollbar-inner">
                    ...
                    <ul class="theme-variants">
                        <li class="theme-variants-item">
                            <a class="theme-variants-link" href="<?php echo base_url() . 'Admin/changeTheme/1' ?>"
                               title="Theme 1">
                                <img class="img-responsive"
                                     src="<?= base_url() ?>assets/<?= $theme ?>/img/f420a3cea0fb04862eb630f5a54b2733.jpg"
                                     alt="Theme 1">
                            </a>
                        </li>
                        <li class="theme-variants-item">
                            <a class="theme-variants-link" href="<?php echo base_url() . 'Admin/changeTheme/2' ?>"
                               title="Theme 2">
                                <img class="img-responsive"
                                     src="<?= base_url() ?>assets/<?= $theme ?>/img/4fcb4322807f1fd92aa3140adb37d4d9.jpg"
                                     alt="Theme 4">
                            </a>
                        </li>
                        <li class="theme-variants-item">
                            <a class="theme-variants-link"
                               href=<?php echo base_url() . 'Admin/changeTheme/3' ?>" title=" Theme 3">
                            <img class="img-responsive"
                                 src="<?= base_url() ?>assets/<?= $theme ?>/img/0100e8b81ad03f81a64a0a5f49c5be41.jpg"
                                 alt="Theme 8">
                            </a>
                        </li>
                        <li class="theme-variants-item">
                            <a class="theme-variants-link" href="<?php echo base_url() . 'Admin/changeTheme/4' ?>"
                               title="Theme 4">
                                <img class="img-responsive"
                                     src="<?= base_url() ?>assets/<?= $theme ?>/img/2ef1cfdcf1da5256d7b994983bd8d457.jpg"
                                     alt="Theme 10">
                            </a>
                        </li>
                        <li class="theme-variants-item">
                            <a class="theme-variants-link" href="<?php echo base_url() . 'Admin/changeTheme/5' ?>"
                               title="Theme 5">
                                <img class="img-responsive"
                                     src="<?= base_url() ?>assets/<?= $theme ?>/img/69ece2eb60bdd2126e2acf27af43aa9b.jpg"
                                     alt="Theme 9">
                            </a>
                        </li>
                        </li>
                        <li class="theme-variants-item">
                            <a class="theme-variants-link" href="<?php echo base_url() . 'Admin/changeTheme/6' ?>"
                               title="Theme 6">
                                <img class="img-responsive"
                                     src="<?= base_url() ?>assets/<?= $theme ?>/img/7a4ee939781f6165006cff1b5b8096d4.jpg"
                                     alt="Theme 12">
                            </a>
                        </li>
                    </ul>
