    ...
    <div class="layout-content-body">
        <div class="row">
            <div style="left: 50%; transform: translateX(-50%);" class="col-md-12">
                <form class="form-horizontal" action="<?=base_url()?>index.php/Admin/do_add" enctype="multipart/form-data" id="product_add" method="post">
                <div class="card">
                            ...
                            <div class="tab-content">
                                ...
                                <form id="add_sub_cat" class="form form-horizontal" style="margin-top: 30px" method="POST">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                          ...
                                          <span class="input-group-addon">
                                                ...
                                                <input class="form-control" type="text" name="title" id="name" placeholder="Name">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <select id="sub_cat_id" class="form-control" name="sub_category" onchange="get_brand(this.value)">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <textarea rows="9"  class="summernotes" data-height="200" cols="100" name="description"></textarea>
                                        </div>
                                    </div>
                                </form>
                                    </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#product_add").on('submit', (function (e) {
            ...
            $.ajax({
                url: '<?php echo site_url("Admin/do_add") ?>',
                data: fd,
                type: "POST",
                contentType: false,
                processData: false,
                ...
                success: function (res) {
                    ...
                    if (res.msg_type == 'success') {
                        ...
                        $("#title").focus();
                        $(".loading").hide();
                        var redirect_link = "<?php echo site_url('Admin/all_products');?>";
                        setTimeout(function(){
