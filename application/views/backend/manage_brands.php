                    ...
                    <div class="card-body">
                            ...
                            <?php for($i=0;$i<count($brands);$i++){?>
                                <tr>
                                    <td><?= $brands[$i]['id']; ?></td>
                                    <td>
                                            <a class="file-link" href="<?=base_url()?>uploads/<?= $brands[$i]['image'] ?>" title="0310728269.jpg">
                                                <div class="file-thumbnail" style="background-image: url(<?=base_url()?>uploads/<?= $brands[$i]['image'] ?>)"></div>
                                            </a>
                                    </td>
                                    <td><?= $brands[$i]['name'] ?></td>
