<div class="layout-content">
    <div class="layout-content-body">
        ...
        <div class="row">
            <div style="left: 50%; transform: translateX(-50%);" class="col-md-12">
                <form class="form-horizontal" action="<?=base_url()?>index.php/Admin/stock/update" enctype="multipart/form-data" id="product_add" method="post">
                <div class="card">
                        ...
                        <div class="tab-base">
                            ...
                            <div class="tab-content">
                                ...
                                <form id="add_sub_cat" class="form form-horizontal" style="margin-top: 30px" method="POST">
                                    ...
                                    <div class="form-group">
                                        <label for="username" class="col-sm-3 control-label" style="width: 20%;" >Category</label>
                                        <div class="col-sm-9">
                                            <?php echo $this->Admin_model->select_html('category', 'cat_id', 'name', 'edit', 'form-control required', $row['cat_id'], 'digital', NULL, 'get_cat'); ?>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="username" class="col-sm-3 control-label" style="width: 20%;" for="form-control-17">Sub Category</label>
                                        <div class="col-sm-9">
                                            <?php echo $this->Admin_model->select_html('sub_category', 'sub_cat_id', 'name', 'edit', 'form-control required', $row['sub_cat_id'], 'cat_id', $row['sub_cat_id'], 'get_brnd'); ?>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <?php
                                            $brands = $this->Admin_model->get_type_name_by_id('sub_category', $row['sub_cat_id'], 'name');
                                            if (count($brands) > 0) {
                                                echo $this->Admin_model->select_html('brands', 'brand', 'name', 'edit', 'form-control', $row['brand_id'], 'id', $brands, '', 'multi');
                                            } else {
                                    ...
                                    <div class="form-group">
                                        <label for="username" class="col-sm-3 control-label" style="width: 20%;" for="form-control-17">Tags</label>
                                        <div class="col-sm-9">
                                            <input type="text" name="tag" data-role="tagsinput"
                                                   placeholder="<?php echo translate('tags'); ?>"
                                                   value="<?php echo $row['tags']; ?>" class="form-control">                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    transition: all .6s ease-in-out;">
                                    ...
                                    <div class="form-group">
                                        <label for="username" class="col-sm-3 control-label" style="width: 20%;" for="form-control-17">Description</label>
                                        <div class="col-sm-9">
                                            <textarea rows="9"  class="summernotes" data-height="200" cols="100" name="description">
                                    ...
                                    <div class="form-group btm_border">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" name="sale_price"
                                                   id="demo-hor-6" min='0'
                                                   step='.01' placeholder="<?php echo translate('sale_price');?>" value="<?php echo $row['sale_price']; ?>" class="form-control required">
                                        </div>
                                    ...
                                    <div class="form-group btm_border">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" name="purchase_price"
                                                   ...
                                                   class="form-control required" value="<?php echo $row['purchase_price']; ?>">
                                        </div>
                                        <!--<span class="btn">pkr/ </span> -->
                                        <span class="btn unit_set"></span>
                                    </div>
                                    ...
                                    <div class="form-group btm_border">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" name="shipping_cost"
                                                   id="demo-hor-8" min='0' step='.01' value="<?php echo $row['shipping_cost']; ?>"
                                    ...
                                    <div class="form-group btm_border">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="number" name="tax" id="demo-hor-9" min='0' step='.01'
                                                   placeholder="<?php echo translate('product_tax');?>" value="<?php echo $row['tax']; ?>" class="form-control">
                                        </div>
                                        <div class="col-sm-1">
                                ...
                                <div id="customer_choice_options" class="tab-pane fade">
                                    ...
                                    <div class="row">
                                                    ...
                                                    <div class="col-md-12" style="margin-bottom:8px;">
                                                        <div class="col-md-10">
                                                            <div class="input-group demo2">
                                                                <input type="text" value="<?php echo $sep_color[$i];?>"name="color[]" class="form-control" />
                                      ...
                                      <span class="col-md-2">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="form-group btm_border">
                                                <label class="col-sm-2 control-label" for="demo-hor-15"><?php echo translate('size'); ?></label>
                                                <div class="col-sm-6"  id="more_size">
                                                    ...
                                                    <div class="col-md-12" style="margin-bottom:8px;">
                                                        <div class="col-md-10">
                                                            <div class="input-group demo2">
                                                                <input type="text" value="<?php echo $sep_size[$i];?>" name="size[]" class="form-control" />
                                                                <span class="input-group-addon"><i></i></span>
                                                            </div>
                                                        </div>
                                      <span class="col-md-2">
                                          <span class="remove_it_v rmc btn btn-danger btn-icon icon-lg icon icon-close" ></span>
                                                ...
                                                <div class="col-sm-2">
                                                    <div id="more_size_btn" class="btn btn-primary btn-labeled fa fa-plus">
